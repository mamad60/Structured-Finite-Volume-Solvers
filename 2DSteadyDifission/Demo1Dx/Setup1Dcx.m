...
% demo1Dx   Verify 2D heat conduction code with a 1D problem.  Boundary conditions
%           are adjusted so that heat flow is in x-direction only.  
%           Constant T on East & West boundaries.  Symmetry
%           on north and south.
