function SetupDemoModel2
%Setups problem for a specific FV problem
% Customize According the problem solved

% DemoModel2 has ? = 0 on all boundaries, ? = 1, 
% and a uniform source term, i.e. S(x, y) = constant

global Xmin Xmax EXX Gamma0 gStat sStat Su0 Sp0 SU SP 
...
sStat=2; %1: No source Term 2: Constant Source Tem 3:Source Term is a function of  x/y
Su0=1; %Base Su
Sp0=0; %Base Sp
