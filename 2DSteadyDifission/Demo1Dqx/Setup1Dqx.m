...
%----------Dirichlet BCs
FIw=30;   % FI at The Left Boundary, Applies only if Bw=0
FIe=80;   % FI at The Right Boundary, Applies only if Be=0
...
qe=(FIe-FIw)/(Xmax-Xmin); % Flux at The Right Boundary, Applies only if Be=1
